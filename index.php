	...
	<div class="container">
		<form action="php/create.php" 
		   ...
		   <button type="submit" 
				  ...
				  <button> <a href="php/registro.colaborador/index.php" class="link-primary">Cadastrar Colaborador</a></button>
				  <button><a href="read.php" class="link-secundary">Ver cadastros</a></button>
	    </form>
	</div>
</body>
</html>